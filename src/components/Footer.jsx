        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-20">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-accentBlue rounded-xl flex items-center justify-center font-black text-black text-xl">F</div>
              <span className="text-2xl font-black tracking-tighter">FAREES</span>
            </div>
            <p className="text-textGray text-sm leading-relaxed max-w-xs">
              Over two decades of excellence in strategic sales management and territory expansion across Sri Lanka.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <a href="mailto:adsmsfaris@gmail.com" className="flex items-center gap-3 text-textGray hover:text-accentBlue transition-colors group">
              ...
              <div className="flex items-start gap-3 text-textGray">
                ...
                <span className="text-sm">No 31B, OPA Road, Addalaichenai, Ampara.</span>
              </div>
            </div>
          </div>
          ...
          {/* Socials & Action */}
          <div className="space-y-6">
            <h4 className="text-white font-bold uppercase tracking-widest text-xs">Connect Professionaly</h4>
            <div className="flex gap-4">
              <a href="#" className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center hover:bg-accentBlue hover:text-black transition-all">
                <Linkedin size={20} />
              </a>
              <button 
                onClick={scrollToTop}
